...
import { Heart, Phone, MapPin, Facebook, Instagram, Twitter, Mail } from "lucide-react"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/shop?category=bouquets" className="text-background/70 hover:text-accent transition-colors text-sm">
                  Bouquets
                </Link>
              </li>
              <li>
                <Link href="/shop?category=soft-toys" className="text-background/70 hover:text-accent transition-colors text-sm">
                  Soft Toys
                </Link>
              </li>
            </ul>
